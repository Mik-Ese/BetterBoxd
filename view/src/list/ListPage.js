        ...
        listItem: [
            {
                ...
                user: 'username123',
                description:
                    'This is the summary of the movie list I realkdjkfiwen jhdf sdfos fhf shfsi ksjfh zsfgo oofa  lis ls  fi kshf sw sgwyiud iush js iu iuh ku  h v  f  uhu sd i i  sdfishfieh fiu esdoie',
                movies: [
                    {
                        movieTitle: 'Shrek',
            ...
            },
            {
                ...
                user: 'username456',
                description:
                    'This is the other summary of the movie list I realkdjkfiwen jhdf sdfos fhf shfsi ksjfh zsfgo oofa  lis ls  fi kshf sw sgwyiud iush js iu iuh ku  h v  f  uhu sd i i  sdfishfieh fiu esdoie',
                movies: [
                    {
